...
class CityLocationDaoTest {
    ...
    fun insertWeatherAlertAndGetWeatherAlert() = runTest {
        ...
        dao.insertAlert(weatherAlert)

        //When, get the alert
        val result = dao.getAlertByID(weatherAlert.id)
    ...
    fun insertCityLocationGetByIdAndGetCityById() = runTest {
        ...
        dao.insertCityLocation(city)

        //When, get the object from db
        val result = dao.getCityById(5)
    ...
    fun deleteAlertTest() = runTest{
        ...
        val result = dao.deleteAlertById(weatherAlert.id)

        // Then, deleted assertion by 1
        assertThat(result, `is`(1))

        //return null of removed row
        val resultAfterDelete = dao.getAlertByID(weatherAlert.id)
